...
//   mechanic,
// }) => {
//   console.log("averageRating", mechanic?.averageRating[0]?.averageRating);
//   const r =  mechanic?.averageRating[0]?.averageRating
...
//             />
//           ))}
//           {r==0?:<span className="text-sm text-gray-600 ml-2">({r})</span>:<span className="text-sm text-gray-600 ml-2">(0)</span>}
