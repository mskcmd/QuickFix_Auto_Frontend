...
import { FaUserCircle, FaPhone, FaSave, FaCamera, FaSpinner } from "react-icons/fa";
      ...
      <div className="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
        ...
        <form onSubmit={formik.handleSubmit} encType="multipart/form-data">
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className={`bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700 transition-colors duration-200 flex items-center justify-center ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={loading}
            >
              {loading ? (
                <>
