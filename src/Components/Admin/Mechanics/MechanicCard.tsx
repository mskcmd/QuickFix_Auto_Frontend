...
// }> = ({ user, index, onToggleBlock, onViewDetails, onImageClick }) =>
//     console.log(user);
//      (
...
//       className={`w-full pyonToggleBlock-2 rounded-full text-sm font-semibold mb-2 transition duration-300 ${
//         user.isBlocked
...
const MechanicCard: React.FC<{
  ...
  console.log(); // Properly placed within the component function
